...
class Orchestrator:
    ...
    def register_agent(self, agent_id: str, agent: 'Agent') -> None:
        try:
            ...
            raise MaestroException(f"Error registering agent {agent_id}: {e}")
    ...
    def assign_task(self, task_id: str, agent_id: str, task: 'Task') -> None:
        try:
            ...
            raise MaestroException(f"Error assigning task {task_id} to agent {agent_id}: {e}")
    ...
    def complete_task(self, task_id: str) -> None:
        try:
            ...
            raise MaestroException(f"Error completing task {task_id}: {e}")
    ...
    def remove_agent(self, agent_id: str) -> None:
        try:
            ...
            raise MaestroException(f"Error removing agent {agent_id}: {e}")